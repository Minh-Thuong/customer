    ...
    return PopScope(
      ...
      child: BlocBuilder<CartBloc, CartState>(
        builder: (context, state) {
          ...
          if (state is PlaceOrderSuccess || state is UpdateOrderStatusSuccess) {
            final order = (state is PlaceOrderSuccess)
                ? state.order
                : (state as UpdateOrderStatusSuccess).order;
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => RebuyScreen()));
              },
