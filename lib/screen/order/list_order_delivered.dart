...
class ListOrderDelivered extends StatefulWidget {
  ...
  @override
  State<ListOrderDelivered> createState() => _ListOrderPendingState();
}

class _ListOrderPendingState extends State<ListOrderDelivered> {
      ...
      MaterialPageRoute(
        builder: (context) => OrderDetailScreenConfirmed(
          ...
          onClose: () {
            ...
            context
                .read<CartBloc>()
                .add(LoadOrderByStatusEvent(status: OrderStatus.DELIVERED));
          },
        ),
      ),
    );
