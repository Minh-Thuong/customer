...
import 'package:customer/screen/order/order_detail_rebuy.dart';
import 'package:customer/screen/order/order_detail_screen2.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:intl/intl.dart';

class ListOrderCancel extends StatefulWidget {
  const ListOrderCancel({super.key});

  @override
  State<ListOrderCancel> createState() => _ListOrderPendingState();
}

class _ListOrderPendingState extends State<ListOrderCancel> {
  ...
  void _navigateToDetail(Order order) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => OrderDetailRebuy(
          order: order,
          onClose: () {
            // Callback này sẽ được gọi từ màn hình chi tiết
            context
                .read<CartBloc>()
                .add(LoadOrderByStatusEvent(status: OrderStatus.CANCELED));
          },
        ),
      ),
    );
