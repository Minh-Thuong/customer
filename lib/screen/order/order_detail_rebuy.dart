...
class OrderDetailRebuy extends StatefulWidget {
  final Order order;
  final VoidCallback onClose;
  const OrderDetailRebuy(
      {super.key, required this.order, required this.onClose});

  @override
  State<OrderDetailRebuy> createState() => _OrderDetailScreenState();
}

class _OrderDetailScreenState extends State<OrderDetailRebuy> {
  @override
  void initState() {
    super.initState();
    context
                  ...
                  SnackBar(
                    content: Row(
                      children: [
                        ...
                        Text(
                          "Đơn hàng đã được mua lại thành công",
